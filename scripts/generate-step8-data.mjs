...
const passives = [
  ...
  { id: 'passive_self_low_hp_dmg', name: '背水の刃', effect: 'selfLowHpDamageScale', scale: 0.6, maxMul: 1.5 },
  ...
  { id: 'passive_damage_vs_dot', name: '追い狩り', effect: 'damageVsDotTarget', scale: 1.3, selfAppliedOnly: true },
  ...
  { id: 'passive_cleric_hot', name: '癒しの息吹', effect: 'partyHotAura', partyHotAuraAmount: { kind: 'atkBased', atkScale: 0.06 } },
  { id: 'passive_heal_barrier', name: '結界付与', effect: 'healAppliesBarrier', barrierScale: 0.5 },
...
const classes = [
  ...
  { id: 'sp_cleric', displayName: '療養師', epithetEn: 'Cleric', flavorJa: '前線に立ち、味方全体をやさしく癒し続ける', role: 'supporter', formationRow: 'front', attackRange: 'melee', attackSpeedTier: 'slow', maxHp: 105, atk: 12, def: 11, reg: 10, growthTier: { maxHp: 2, atk: 1, def: 2 }, passiveIds: ['passive_cleric_hot'] },
