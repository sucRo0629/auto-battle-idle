...
const SKILL_TEXT = {
  ja: {
    ...
    skillLock: "硬直",
    moveLock: "移動停止",
    skillLockAndMoveLock: (n: number) => `硬直・移動停止${n}秒`,
    skillLockOnly: (n: number) => `硬直${n}秒`,
    damagePhysical: "物理",
    damageMagic: "魔法",
    metaJoiner: " / ",
    labelColon: "：",
  ...
  en: {
    ...
    skillLock: "Lockout",
    moveLock: "Root",
    skillLockAndMoveLock: (n: number) => `Lockout + Root ${n}s`,
    skillLockOnly: (n: number) => `Lockout ${n}s`,
