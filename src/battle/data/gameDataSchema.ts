...
export const ROLES = ['defender', 'attacker', 'supporter'] as const satisfies readonly Role[];
export const FORMATION_ROWS = ['front', 'middle', 'back'] as const satisfies readonly FormationRow[];
export const ATTACK_RANGES = ['melee', 'ranged'] as const satisfies readonly AttackRange[];
...
export const DAMAGE_TYPES = ['physical', 'magic'] as const satisfies readonly DamageType[];
export const VFX_PRESETS = ['slash', 'orb', 'arrow', 'healRise'] as const satisfies readonly SkillVfxPresetId[];
...
export const POWER_STEP_MODES = ['multiply', 'divide'] as const satisfies readonly import('../types.ts').PowerStepMode[];
...
export const STATUS_EFFECT_STATS = ['atk', 'def', 'reg', 'damageTaken'] as const satisfies readonly StatusEffectStat[];
...
export const GROWTH_PRESET_KEYS = ['attacker', 'caster'] as const satisfies readonly GrowthPresetKey[];
...
export const ATTACK_SPEED_TIER_OPTIONS: AttackSpeedTier[] = [...ATTACK_SPEED_TIERS];
export const GROWTH_TIER_OPTIONS: GrowthTier[] = [...GROWTH_TIERS];
export const GROWTH_PRESET_KEY_OPTIONS: GrowthPresetKey[] = [...GROWTH_PRESET_KEYS];
...
export const SKILL_EFFECT_KIND_OPTIONS: SkillEffectKind[] = [...SKILL_EFFECT_KINDS];
...
export const PASSIVE_EFFECT_KIND_OPTIONS: PassiveEffectKind[] = [...PASSIVE_EFFECT_KINDS];
export const STATUS_EFFECT_STAT_OPTIONS: StatusEffectStat[] = [...STATUS_EFFECT_STATS];
