...
## 8. 現在地メモ（更新: 2026-07-15・R12 サブフェーズ再編）
...
| **R12c** | **設計確定**（作戦全体の敵問題・Wave 間関係）。**spec 正本化は次** |
| **公式次タスク** | **R12c** — 作戦全体の敵問題の spec 正本化（`operation-loop.md` §17 候補） |
...
## 8c. R12 データ再設計（更新: 2026-07-15・Stage 先行順へ再編）
...
| **R12c** | **作戦全体の敵問題**（Wave 間関係・編成・資源・汎用編成の扱い） | **設計確定** / **spec 正本化は次** |
| **R12d** | 試作 Stage の敵問題設計（JSON 入力なし） | 未着手 |
| **R12e** | 必要能力・対処能力の導出 | 未着手 |
| **R12f** | 兵科・CombatModule・作戦内パッシブへの分配（設計） | 未着手 |
