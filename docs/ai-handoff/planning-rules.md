...
## 8c. R12 データ再設計（更新: 2026-07-15・R12a 完了）

| ID | 内容 | 状態 |
| -- | ---- | ---- |
| **R12a** | 敵問題・戦術目標・敗因の識別可能性を spec 正本化。勝利条件＝敵全滅 | **完了** |
| **R12b** | **1 Wave 単位の敵問題設計** | 公式次 |
| **R12c** | 試作作戦 Stage / Wave データ再設計 | 未着手 |
| **R12d** | 手元成立ゲート | 未着手 |
| **R13** | 「繰り返し遊びたいか」 | R12 後 |

旧 R12b 案（CombatModule / 作戦内パッシブデータ再設計）の着手順は R12b 完了後に確定。
