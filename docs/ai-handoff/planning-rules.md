...
## 8. 現在地メモ（更新: 2026-07-16・R12g-d5 完了）
...
| **公式次タスク** | **R12g-d6** — Kill 兵科の CombatModule データ再設計（1 兵科。順は roadmap） |
...
| **R12g** | class / module / passive データ再設計 | R12g-d2 Backend 完了。次 R12g-d3 |
