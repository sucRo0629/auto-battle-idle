...
| **R7** | 反復プレイ — 倍速、Wave 再生 / 再試行、作戦最初からの再試行 | **R7d 完了** → R7e 次 |
...
**R7a 調査完了（2026-07-12）:** [current-task.md §69](../ai-handoff/current-task.md#69-r7a--反復プレイ調査タスク分割2026-07-12-完了)。**R7b 完了（2026-07-12）:** [current-task.md §70](../ai-handoff/current-task.md#70-r7b--倍速-simulation2026-07-12-完了) — `GameSession` tick gate で 1/2/4 倍。**R7c 完了（2026-07-12）:** [current-task.md §71](../ai-handoff/current-task.md#71-r7c--敗北時-retry-正式導線2026-07-12-完了) — verify OFF 敗北で retry 3 種 UI・legacy auto-restart 廃止。**R7d 完了（2026-07-12）:** [current-task.md §72](../ai-handoff/current-task.md#72-r7d--wave-準備-retry--spec-整合2026-07-12-完了) — `wavePrep` から retry 3 種・formation suspend 往復。
...
**次タスク:** **R7e** — 作戦結果後再戦 + 遷移統一（`operationResult` から rematch・勝利後導線）。
