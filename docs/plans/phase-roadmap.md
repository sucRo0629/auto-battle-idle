...
| **R8** | 作戦内パッシブ — リソース消費・任意取得・巻き戻し、**戦闘中表示整理**、**範囲パッシブ runtime 判定 + プレースホルダ範囲描画**（正式 VFX は後続） | **R8d 完了** → R8e 次 |
...
**次タスク:** **R8e** — 戦闘中表示整理（常時 stat 補正非表示・条件付き発動中のみアイコン・ally HUD read-only 一覧）。
