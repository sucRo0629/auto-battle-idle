...
| **R12** | 試作をゲームにする — Stage 先行の敵問題設計 → 能力導出・分配 → データ実装 → 手元成立 | R12a〜f 設計完了 / R12g-a〜c3 完了 | R12a〜f 設計 Phase 完了。ゲーム成立は **R12j** | **R12g-c4 へ** |
...
| **R12g-c4** | 護法士 M2 防護 runtime / Module action | 未着手 |
